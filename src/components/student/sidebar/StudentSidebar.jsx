...
import { LayoutDashboard, Layers, BarChart2, User, LogOut, Menu, Mail, BookOpen, ClipboardList, Megaphone, CalendarCheck, X, Download, Award } from "lucide-react";
        ...
        {!collapsed ? (
          <div className="pt-2 pb-3 px-4 border-b border-[#F1F5F9] relative flex flex-col items-center shrink-0">
            ...
            <button
              ...
              className="absolute top-2 right-2 p-1.5 rounded-lg hover:bg-slate-100 text-slate-400 hover:text-slate-600 transition hidden lg:block"
            >
              <Menu size={16} />
            </button>
            <button
