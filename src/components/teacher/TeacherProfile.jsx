          ...
          <div className="px-6 md:px-8 pb-8">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-end gap-6 -mt-16 mb-6">
              <div className="relative">
                <div className="w-32 h-32 bg-emerald-500 rounded-lg shadow-lg flex items-center justify-center text-white text-5xl font-bold border-4 border-white">
            ...
            <div className="mb-6">
              ...
              {isEditing ? (
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 outline-none resize-none"
...
function StatBox({ icon, label, value, iconColor, iconBgColor, borderColor }) {
  return (
    <div className={`bg-white border ${borderColor} rounded-lg p-4 shadow-sm`}>
      <div className={`${iconBgColor} p-2.5 rounded-lg border ${borderColor} mb-3 inline-flex`}>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 pr-12 rounded-lg border border-gray-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 outline-none"
